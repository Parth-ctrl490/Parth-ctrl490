<p align="center">
  <img src="Gemini_Generated_Image_6w9yoa6w9yoa6w9y.png" alt="Parth Shukla" width="500"/>
</p>
...
<div align="center">
  ...
  **Full-Stack Developer | Backend Engineer | Problem Solver**
  ...
  [![LeetCode](https://img.shields.io/badge/LeetCode-1567%20Rating-orange?style=flat&logo=leetcode)](https://leetcode.com/u/NrIHWU93sE/)
  [![HackerRank](https://img.shields.io/badge/HackerRank-5%20Star-green?style=flat&logo=hackerrank)](https://www.hackerrank.com/profile/AIML1_2310215)
...
- 🔭 Currently building **Echo AI (Voice Assistant) & VoteBuddy (Civic-Tech Web App)**
- 🌱 Learning **Next.js, Golang, Kubernetes and Redis**
- 🏆 **Hackathon Winner** – Zero Boundaries 2025 | **NASA Space Apps 2025** Team Leader
- 💬 Ask me about **React.js, Node.js, Flask, REST APIs, DSA**
- ☁️ **AWS Certified** – Cloud Practitioner Essentials
- 📫 Reach me at **2k23.psitaiml2310215@gmail.com**
- ⚡ LeetCode: **1567 Rating | 250+ Problems | 100-Day Streak** 🚀
...
Multilingual voice assistant with microservices-style Flask REST API backend and React.js frontend. Real-time communication via WebSockets, MongoDB for data persistence.
...
#### 🗳️ VoteBuddy – Civic Tech App
🏆 **Hackathon Winner** – AI-powered full-stack civic-tech web app delivering personalized voting guidance via Flask REST APIs and OpenAI integration.

**Tech Stack:** `JavaScript` `Flask` `REST APIs` `OpenAI API` `HTML` `CSS`
...
#### ♻️ PlastiSat – NASA Space Apps 2025
AI-powered marine plastic waste detection using NASA Earth observation data and YOLOv8 computer vision. Led 4-member team.

**Tech Stack:** `Python` `YOLOv8` `Computer Vision` `NASA APIs`
...
#### 📚 Online Bookstore
Full-featured web app with cart system, user authentication, and REST API backend.
...
#### 🎯 OOP in Java
Classes, inheritance, polymorphism, and encapsulation with practical examples.
...
#### 💡 LeetCode Solutions
250+ problems solved | Rating 1567 | 100-Day Streak Badge.

[🔗 Repository](https://github.com/Parth-ctrl490/Leetcode)
...
- 🌐 **HTML & CSS3** – Infosys Springboard, 2024
- 🗄️ **Database Management System** – Infosys Springboard, 2026
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:2k23.psitaiml2310215@gmail.com)
[![LeetCode](https://img.shields.io/badge/LeetCode-000000?style=for-the-badge&logo=LeetCode&logoColor=#d16c06)](https://leetcode.com/u/NrIHWU93sE/)
[![HackerRank](https://img.shields.io/badge/HackerRank-2EC866?style=for-the-badge&logo=HackerRank&logoColor=white)](https://www.hackerrank.com/profile/AIML1_2310215)
